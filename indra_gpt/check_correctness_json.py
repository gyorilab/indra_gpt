...
SENTENCE = "\"CDC37 silencing promoted the proteasome mediated degradation " \
           "of kinase clients.\""

SENTENCE_1 = "\"The previous experiment demonstrated that both Sp1 and Sp3 " \
           "activate the utrophin transcription in the heterologous SL2 " \
           "cells.\""

SENTENCE_2 = "\"Hyperactivation of Akt inhibits Chk1 phosphorylation after " \
...
SENTENCE_5 = "\"CCL20 production was synergistically augmented by a " \
...
response_check = openai.ChatCompletion.create(
  ...
  messages=[
    {
      "role": "user",
      "content": "Verify if a sentence I give you implies a statement I give you. Provide a correct answer with a simple yes or no. Sentence: " + SENTENCE_5 + " Statement: " + str(stmt)
    }
  ],
  temperature=0,
  max_tokens=6000,
